...
describe SalesRepsController do
  ...
  # adjust the attributes here as well.
   ...
   let(:valid_attributes_2) { { first_name: "Steve", last_name: "Smith"  } }
   let(:valid_attributes_3) { { first_name: "Mark", last_name: "Anderson"  } }
  ...
  describe "GET index" do
    ...
    # end
    before do
      @sales_rep1 =  SalesRep.create! valid_attributes
      @sales_rep2 = SalesRep.create! valid_attributes_2
      # @expected = @sales_rep1.to_json
      # @expected = "{\"id\":\"#{@sales_rep1.id}\",\"nf\":\"Seth\",\"nl\":\"McFee\"}"
      @expected = "{\"id\":\"#{@sales_rep2.id}\",\"first_name\":\"Steve\",\"last_name\":\"Smith\"}"
    end
...
#
    # describe "with invalid params" do
      # it "assigns a newly created but unsaved sales_rep as @sales_rep" do
        ...
        # post :create, {:sales_rep => {  }}, valid_session
        # assigns(:sales_rep).should be_a_new(SalesRep)
      # end
#
  ...
  # describe "PUT update" do
    # describe "with valid params" do
      # it "updates the requested sales_rep" do
        ...
        # SalesRep.any_instance.should_receive(:update_attributes).with({ "these" => "params" })
        # put :update, {:id => sales_rep.to_param, :sales_rep => { "these" => "params" }}, valid_session
      # end
#
      # it "assigns the requested sales_rep as @sales_rep" do
        # sales_rep = SalesRep.create! valid_attributes
...
#
    # describe "with invalid params" do
      # it "assigns the sales_rep as @sales_rep" do
        ...
        # # Trigger the behavior that occurs when invalid params are submitted
        # SalesRep.any_instance.stub(:save).and_return(false)
        # put :update, {:id => sales_rep.to_param, :sales_rep => {  }}, valid_session
        # assigns(:sales_rep).should eq(sales_rep)
      # end
#
